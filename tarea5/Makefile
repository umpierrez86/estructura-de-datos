...
ARCHIVO_ENTREGA=Entrega5.tar.gz

ENTREGAR = cadena colCadenas iterador abb pila cola mapping aplicaciones
...
# casos de prueba
IDS = 10 20 30 40 50 60 71 72 73 74 75 76
IDS_TIEMPO = abb cadena colCadenas cola esAVL filtradaOrdenada iterador mapping menoresAbb menoresQueElResto ordenadaPorModulo palabras pila
