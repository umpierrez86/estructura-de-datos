...
/*
  ...
  si la rotación fuera consecuencia de un desbalance producido por esa inseción.
  Por ejemplo tipo[0] = 'L' y tipo[1] = 'R' significa que la inserción se
  habría hecho en el subárbol izquierdo del nodo en el que se aplica la
  rotación, y a su vez en el subárbol derecho del hijo izquierdo de ese nodo.
